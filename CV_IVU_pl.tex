...
\includegraphics[width=0.6\columnwidth]{foto.jpg}\\[\baselineskip] % Your photo
\small % Smaller font size
Jakub Opatowski\\ % Your name
\url{jakub.opatowski@gmail.com} \\ % Your email address
%\url{www.johnsmith.com} \\ % Your URL
(\#48) 512 139 650 \\ % Your phone number
\Sep % Some whitespace
\textbf{Address} \\
...
\cvheading{Jakub Opatowski} % Large heading - your name

\cvsubheading{C++ Software Engineer} % Subheading - your occupation/specialization
